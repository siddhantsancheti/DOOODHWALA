// DOOODHWALA — Milkman / Supplier Terms & Conditions (India).
//
// Source of truth for the text shown on the in-app acceptance screen and on
// the public /terms/milkman page. Bump MILKMAN_TERMS_VERSION when the text
// changes materially, and give the notice required by clause 18.1.
//
...
export const MILKMAN_TERMS_VERSION = "milkman-2026-08-07";
export const MILKMAN_TERMS_LAST_UPDATED = "7 August 2026";

export const MILKMAN_TERMS_MARKDOWN = `
# DOOODHWALA — Terms and Conditions (Milkman / Supplier)

Operated by: [Legal Entity Name], [Pvt. Ltd. / LLP / Proprietorship], CIN/LLPIN: [—], GSTIN: [—], registered office at [Address] ("DOOODHWALA", "Platform", "we", "us").
...
5.2 You must give Customers advance notice of at least [7] days before any price increase takes effect, through the app.
...
9.4 DOOODHWALA may set off, withhold or recover from amounts due to you: verified Customer refunds, chargebacks, penalties for confirmed adulteration or false billing, and amounts paid to you in error. We will notify you with reasons before any deduction above INR [—].
...
- **Address:** [Full postal address in India]
- **Email:** [grievance@dooodhwala.com]
- **Phone:** [—]
...
17.4 Subject to the above, the courts at [City], [State] shall have exclusive jurisdiction.
