...
export const CUSTOMER_TERMS_VERSION = "customer-2026-08-07";
export const CUSTOMER_TERMS_LAST_UPDATED = "7 August 2026";
...
4.3 Notify us immediately at [grievance@dooodhwala.com] of any unauthorised use. DOOODHWALA is not liable for loss arising from your failure to safeguard credentials.
...
8.5 Late payment may attract suspension of service after [—] days and interest of [—]% per month on overdue amounts, subject to applicable law.
...
9.4 We may suspend or terminate your account, with notice where reasonably practicable, for non-payment, breach of these Terms, fraud, abuse of delivery personnel, or where required by law or a court/government order.
...
11.2 DOOODHWALA acts as a Data Fiduciary. We collect your name, mobile number, delivery address, geolocation (where enabled), order history and payment references for the purpose of providing dairy delivery services, billing, customer support and legal compliance.
...
17.3 Failing amicable resolution, the dispute shall be referred to arbitration by a sole arbitrator appointed by [mutual consent / the manner set out here], under the Arbitration and Conciliation Act, 1996. The seat and venue of arbitration shall be [City], [State], and the language shall be English. The award shall be final and binding.
